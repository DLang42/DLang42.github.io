...
![image](/images/coffeeshop/sign-up/sign-up.png)
![image](/images/coffeeshop/sign-up/sign-up-success.png)
...
![image](/images/coffeeshop/sign-up/sign-up-username-exists-error.png)
...
![image](/images/coffeeshop/sign-up/sign-up-username-too-short-error.png)
...
![image](/images/coffeeshop/sign-up/sign-up-password-too-short-error.png)
...
![image](/images/coffeeshop/sign-up/sign-up-passwords-dont-match-error.png)
...
![image](/images/coffeeshop/sign-up/sign-up-manager-exists-error.png)
...
![image](/images/coffeeshop/login/login.png)
...
![image](/images/coffeeshop/login/login-as-guest.png)
![image](/images/coffeeshop/guest/login-success-guest.png)
...
![image](/images/coffeeshop/login/login-error.png)
...
![image](/images/coffeeshop/manager/add-ingredient-option.png)
...
![image](/images/coffeeshop/manager/add-ingredient-menu.png)
...
![image](/images/coffeeshop/manager/update-inventory-option.png)

2. You can view the current inventory in the "View Inventory" view of the Update Inventory form

![image](/images/coffeeshop/manager/update-inventory-menu.png)
...
![image](/images/coffeeshop/manager/update-inventory-form-complete.png)
...
![image](/images/coffeeshop/manager/edit-recipe-option.png)

2. Select the desired Recipe you want to edit from the drop-down menu

![image](/images/coffeeshop/manager/edit-recipe-menu.png)
...
![image](/images/coffeeshop/manager/edit-recipe-form-complete.png)
...
![image](/images/coffeeshop/manager/delete-recipe-option.png)
...
![image](/images/coffeeshop/manager/delete-recipe-menu.png)
...
![image](/images/coffeeshop/manager/view-orders-option.png)
...
![image](/images/coffeeshop/manager/view-orders-menu.png)
...
![image](/images/coffeeshop/barista/add-recipe-option.png)
...
![image](/images/coffeeshop/barista/add-recipe-menu.png)
...
![image](/images/coffeeshop/barista/fulfill-orders-order-fulfilled.png)
...
![image](/images/coffeeshop/customer/place-order-placed-order.png)
...
![image](/images/coffeeshop/customer/order-history-option.png)

Then, you will be shown the following screen where "awaleed" is the customer's username:

![image](/images/coffeeshop/customer/order-history-menu.png)
...
![image](/images/coffeeshop/customer/order-history-status-ready-for-pickup.png)
...
![image](/images/coffeeshop/customer/order-history-status-picked-up.png)
...
![image](/images/coffeeshop/guest/place-order-option.png)

2. The menu shows available menu items along their prices and the ingredients in the recipe. 

![image](/images/coffeeshop/guest/place-order-menu.png)

3. Select the desired recipe you want to order from the menu and click "Add to Order". 

![image](/images/coffeeshop/guest/place-order-add-to-cart.png)
...
![image](/images/coffeeshop/guest/place-order-placed-order.png)
